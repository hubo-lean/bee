        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex min-h-[44px] min-w-[64px] flex-col items-center justify-center gap-1 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2",
